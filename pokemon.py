...
class Pokemon(Status, Ataques):                                                             # Define a classe Pokemon como uma subclasse de Status e Ataques
    ...
    def subir_de_nivel(self):                                                               # Define o método subir_de_nivel
    ...
    def atacar(self, pokemon: Type['Pokemon']):                                             # Define o método atacar
    ...
    def status_up(self, nivel):                                                             # Define o método status_up
